function t396_init(e) {
  ...
  d &&
    ...
    window.addEventListener("load", function () {
      ...
      "function" == typeof t_lazyload_update &&
        ...
        d.addEventListener(
          "scroll",
          t_throttle(function () {
            var t = i ? i.getAttribute("data-watchIn-lazy") : null;
            ("y" !== window.lazy && "yes" !== t) ||
    ...
    (r = i ? "edit" === i.getAttribute("data-watchIn-mode") : null),
    t &&
      !r &&
...
function t396__initOnlyScalable() {
  ...
  void 0 === window.isOnlyScalable &&
    ((t = (t = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./))
      ? parseInt(t[1], 10)
      : 126),
...
function t396_doResize(t) {
  var e = t396_isOnlyScalableBrowser(),
    ...
    e =
      ...
      n ? n.getAttribute("data-watchIn-mode") : "");
  r &&
    "edit" !== e &&
    t_onFuncLoad("t396_scaleBlock", function () {
      t396_scaleBlock(t);
...
function t396_ab__renderView(t) {
  ...
  var o,
    ...
    i = !!i && "edit" === i.getAttribute("data-watchIn-mode"),
...
function t396_elem__renderViewOneField(t, e) {
  if ((t = t396_getEl(t))) {
    var i = document.getElementById("allrecords"),
      i = i ? i.getAttribute("data-watchIn-mode") : "",
      n =
        "window" ===
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  if ((t = t396_getEl(t))) {
    var n = t.closest(".t396__artboard"),
      ...
      n = document.getElementById("allrecords"),
      d = "edit" === (n ? n.getAttribute("data-watchIn-mode") : ""),
    ...
    switch (e) {
      case "left":
        ...
        !d && l ? "grid" === g && _ && (i *= f) : (i = b + i),
          ...
          s &&
            "window" !== h &&
            (i += ((x = t396_elem__getWidth(t)) * f - x) / 2);
        break;
      case "top":
        function v(t) {
          var e,
        ...
        l && !d && x && (A = parseInt(b, 10) * f),
          "center" === c &&
            ...
            d ||
              ...
              "window" === h ||
              "stretch" !== a ||
              ((y = A ? (S < A ? A : S) : F.clientHeight), (y /= f)),
            (i = y / 2 - V / 2 + i)),
          "bottom" === c &&
            ((V = v(t)),
            s &&
          ...
          s &&
            "window" !== h &&
            ((x = ((V = v(t)) * f - V) / 2), (i += x = Math.round(x)));
    }
    return i;
  }
}
    ...
    var i =
      ...
      a =
        n === o
          ...
          : t.getAttribute("data-group-" + e + "-res-" + n + "-value");
    if (null === a)
