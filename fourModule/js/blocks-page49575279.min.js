...
function t702_initPopup(recId) {
  ...
  if (popupTooltipHook) {
    ...
    document.addEventListener("click", function (event) {
      ...
      t702__lazyLoad();
      if (analitics && window.watchIn) {
        watchIn.sendEventToStatistics(analitics, popupTooltipHook);
      }
    });
  ...
  popup.addEventListener("watchInmodal:show" + popupTooltipHook, function () {
    document.addEventListener("keydown", t702_escClosePopup);
  });
  popup.addEventListener("watchInmodal:close" + popupTooltipHook, function () {
...
function t702_showPopup(recId) {
  ...
  t702__lazyLoad();
  t702__triggerEvent(popup, "watchInmodal:show" + popupTooltipHook);
...
function t702_closePopup(recId) {
  ...
  t702__triggerEvent(popup, "watchInmodal:close" + popupTooltipHook);
}
function t702_sendPopupEventToStatistics(popupName) {
  var virtPage = "/watchIn/popup/";
  var virtTitle = "Popup: ";
  ...
  virtPage += popupName;
  virtTitle += popupName;
  if (window.watchIn && typeof watchIn.sendEventToStatistics == "function") {
    watchIn.sendEventToStatistics(virtPage, virtTitle, "", 0);
  } else {
    if (ga) {
      if (window.mainTracker != "watchIn") {
...
function t702__lazyLoad() {
  if (
    window.lazy === "y" ||
    document.getElementById("allrecords").getAttribute("data-watchIn-lazy") ===
      "yes"
  ) {
