...
function t_scrollBarWidthCompensator__init() {
  ...
  window.isMobile ||
    ...
    ((r = window.scrollBarWidthCompensator).scrollBarWidth = Math.abs(
      window.innerWidth - document.documentElement.clientWidth
    )),
    r.cancelTimeout &&
      (window.clearTimeout(r.cancelTimeout), (r.cancelTimeout = null)),
    !r.isInited &&
      r.scrollBarWidth &&
      ((r.isInited = !0),
      (t = window
      ...
      (e = document.body.style.paddingRight) &&
        document.body.setAttribute("data-watchIn-initial-padding-right", e),
      (document.body.style.paddingRight = r.scrollBarWidth + t + "px"),
      (document.body.style.height = "100vh"),
      (document.body.style.minHeight = "100vh"),
      (document.body.style.overflow = "hidden"),
      (l = []),
      Array.prototype.forEach.call(r.fixedElements, function (t) {
        var e,
          n,
          i,
          o,
        ...
        !document.body.contains(a) ||
          ...
          ((n = t.getPropertyValue("transition-duration")).indexOf("ms") + 1
            ? ((n = parseInt(n.replace("ms", ""), 10)), l.push(n))
            : n.indexOf("s") + 1 &&
              ((n = 1e3 * parseFloat(n.replace("s", ""))), l.push(n)),
          (n = t.getPropertyValue("right")),
          (n = parseInt(n.replace("px", ""), 10)),
          (o = t.getPropertyValue("width")),
          (t = t.getPropertyValue("height")),
          (i = a.style.right) &&
            a.setAttribute("data-watchIn-initial-right", i),
          (i = a.style.width) &&
            a.setAttribute("data-watchIn-initial-width", i),
          (i =
            "100%" === o ||
            o === window.innerWidth + "px" ||
            o === window.innerWidth - r.scrollBarWidth + "px" ||
            "100vw" === o),
          (o =
            "100%" === t ||
            t === window.innerHeight + "px" ||
            t === window.innerHeight - r.scrollBarWidth + "px" ||
            "auto" === t ||
            "100vh" === t),
          (!n && 0 !== n) || "auto" === a.style.right || "absolute" === e || i
            ? i &&
              !o &&
              (a.style.width = "calc(100vw - " + r.scrollBarWidth + "px)")
            : (a.style.right = r.scrollBarWidth + n + "px"));
      }),
      l.length && (r.delay = Math.max.apply(null, l))));
}
function t_scrollBarWidthCompensator__cancel() {
  ...
  t &&
    ...
    ((t.isInited = !1),
    (t.delay = 0),
    document.body.hasAttribute("data-watchIn-initial-padding-right")
      ? ((document.body.style.paddingRight = document.body.getAttribute(
          "data-watchIn-initial-padding-right"
        )),
        document.body.removeAttribute("data-watchIn-initial-padding-right"))
    ...
    Array.prototype.forEach.call(t.fixedElements, function (t) {
      var t = t.el,
        e =
          t.classList.contains("tn-atom__sticky-wrapper") ||
          t.classList.contains("tn-atom__sbs-anim-wrapper");
      t.hasAttribute("data-watchIn-initial-right")
        ? ((t.style.right = t.getAttribute("data-watchIn-initial-right")),
          t.removeAttribute("data-watchIn-initial-right"))
        : t.style.removeProperty("right"),
        t.hasAttribute("data-watchIn-initial-width")
          ? ((t.style.width = t.getAttribute("data-watchIn-initial-width")),
            t.removeAttribute("data-watchIn-initial-width"))
          : (t.style.removeProperty("width"), e && (t.style.width = "inherit"));
    }));
}
...
(window.isSearchBot = !1),
  ...
  (window.browserLang = (
    ...
    .toUpperCase()
    .slice(0, 2)),
  (window.watchInBrowserLang = window.browserLang),
  t_onReady(function () {
    var t,
      e = document.getElementById("allrecords");
    (t = e ? e.getAttribute("data-watchIn-project-lang") : t) &&
  ...
  t_onReady(function () {
    setTimeout(function () {
      var t = document.querySelector("html"),
        e = document.querySelector(".t-watchInlabel"),
        n = t.offsetHeight;
      if (
        (document.body &&
          (n = Math.max(
        ...
        (document.getElementById("watchIncopy") || e) &&
  ...
  t_onReady(function () {
    ...
    var t = document.querySelector("html"),
      ...
      m =
        ...
        document.querySelector(".t-watchInlabel")),
      h = h
        ? Math.max(
            h.scrollHeight,
            h.offsetHeight,
