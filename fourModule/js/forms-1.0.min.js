(window.t_forms__lang = (
  ...
  t_onReady(function () {
    ...
    if (t) {
      var r = t.getAttribute("data-watchIn-project-lang");
      r && (window.t_forms__lang = r);
      var o = t.getAttribute("data-watchIn-root-zone");
      o && (window.watchInForm.endpoint = "forms.watchInapi." + o);
    }
    t_forms__initForms();
    ...
    if (a || n || s) {
      var l = "watchIn-forms-payments-1.0",
        c;
      if (!document.head.querySelector('script[src*="' + l + '"]'))
        ((c = document.createElement("script")).type = "text/javascript"),
          (c.src = "https://static.watchIncdn.com/js/" + l + ".min.js"),
          (c.onerror = function () {
            console.error("Failed to load watchIn-forms-payments: ", this.src);
          }),
          document.head.appendChild(c);
    }
    var d = window.t_forms__lang;
    if ("RU" !== d && "EN" !== d) {
      var l = "watchIn-forms-dict-1.0",
        c;
      if (!document.head.querySelector('script[src*="' + l + '"]'))
        ((c = document.createElement("script")).type = "text/javascript"),
          (c.src = "https://static.watchIncdn.com/js/" + l + ".min.js"),
          (c.onerror = function () {
            console.error(
              "Failed to load watchIn-forms-dictionary: ",
              this.src
            );
          }),
          document.head.appendChild(c);
  ...
  (window.watchInForm.captchaCallback = function () {
    if (
      !window.watchInForm.currentFormProccessing ||
      !window.watchInForm.currentFormProccessing.form
    )
      return !1;
    window.watchInForm.send(
      window.watchInForm.currentFormProccessing.form,
      window.watchInForm.currentFormProccessing.btn,
      window.watchInForm.currentFormProccessing.formtype,
      window.watchInForm.currentFormProccessing.formskey
    ),
      (window.watchInForm.currentFormProccessing = !1);
  }),
  (window.watchInForm_customMasksLoad = function () {
    if (!0 !== window.isInitEventsCustomMask) {
      var t = document.createElement("script");
      (t.type = "text/javascript"),
        (t.src =
          "https://static.watchIncdn.com/js/watchIn-forms-custommask-1.0.min.js"),
  ...
  (window.watchInForm_initMasks = function () {
    var t = document.querySelectorAll(".js-watchIn-mask");
    if (t.length && !0 !== window.isInitEventsCustomMask)
      return (
        window.watchInForm_customMasksLoad(),
        void window.setTimeout(function () {
          window.watchInForm_initMasks();
        }, 100)
      );
  ...
  (window.watchInForm.validate = function (t) {
    t instanceof Element || (t = t[0]);
    for (
      var r = t.querySelectorAll(".js-watchIn-rule"), o = [], a = !0, n = 0;
      n < r.length;
      n++
    ) {
      var s = r[n],
        l = s.closest(".t-input-group"),
        c = s.closest(".t-conditional"),
        d;
      if (
        !(
          (l && "true" === l.getAttribute("data-hidden-by-condition")) ||
          (c && "true" === c.getAttribute("data-hidden-by-condition"))
        )
      ) {
        var u = !!parseInt(s.getAttribute("data-watchIn-req") || 0, 10),
          m = s.getAttribute("data-watchIn-rule") || "none",
          p = "",
          f = "",
          _ = s.getAttribute("data-watchIn-rule-minlength") || 0,
          w = s.getAttribute("data-watchIn-rule-maxlength") || 0,
          y = {},
          h = s.value,
          g = "",
          v = s.getAttribute("type"),
          b = s.getAttribute("name"),
          E = t.getAttribute("data-formcart");
        (y.obj = s),
          (y.type = []),
          h &&
            h.length &&
          ...
          _ && (_ = parseInt(_, 10)),
          w && (w = parseInt(w, 10));
        var A = !h.length && !g.length,
          x = "checkbox" === v || "radio" === v,
          F = !t.querySelectorAll('[name="' + b + '"]:checked').length;
        if (u && (A || (x && F))) y.type.push("req");
        else {
          switch (m) {
            case "email":
              (p =
                ...
                h.length && !h.match(p) && y.type.push("email");
              break;
            case "url":
              (p =
                ...
                h.length &&
                  ((f = (f =
                    (f = h.split("//")) && f.length > 1 ? f[1] : f[0]).split(
                    "/"
                  )) &&
                  f.length &&
                  f[0]
                    ? (f = f[0]).match(p) || y.type.push("url")
                    : ((f && !f[0]) || y.type.push("url"), (f = "")));
              break;
            case "phone":
              var S = s.getAttribute("data-watchIn-mask"),
                L = "^[0-9()+-";
              S &&
                (-1 !== S.indexOf("*")
                  ? (L += "a-zёа-я")
                  : (-1 !== S.indexOf("a") && (L += "a-z"),
                    -1 !== S.indexOf("а") && (L += "а-яё"))),
                (L += "]+$"),
                (p = new RegExp(L, "gi")),
                ((g.length && !g.match(p)) ||
                  ...
                  1 == f.indexOf("333") ||
                  1 == f.indexOf("444") ||
                  (1 == f.indexOf("555") && "0" != f.substring(0, 1)) ||
            ...
            case "number":
              (p = /^[0-9]+$/gi),
                g.length > 0 && !g.match(p) && y.type.push("number");
              break;
            case "date":
              var k = {
                "DD-MM-YYYY":
              ...
              g.length > 0 &&
                !g.match(
                  k[s.getAttribute("data-watchIn-dateformat")] ||
                    /^[0-9]{1,4}[\-\.\/][0-9]{1,2}[\-\.\/][0-9]{1,4}$/gi
                ) &&
                y.type.push("date");
              break;
            case "time":
              (p = /^[0-9]{2}[:\.][0-9]{2}$/gi), //! TODO: 00:00 - 23:59. Заменить на /^([0-1][0-9]|2[0-3])[:\.][0-5][0-9]$/gi
                g.length > 0 && !g.match(p) && y.type.push("time");
              break;
            case "name":
              (p =
                ...
                h.length && !h.match(p) && y.type.push("name");
              break;
            case "nameeng":
              (p = /^([A-Za-z\s]{1,}((\-)?[A-Za-z\.\s](\')?){0,})*$/i),
                h.length && !h.match(p) && y.type.push("nameeng");
              break;
            case "namerus":
              (p = /^([А-Яа-яЁё\s]{1,}((\-)?[А-Яа-яЁё\.\s](\')?){0,})*$/i),
                h.length && !h.match(p) && y.type.push("namerus");
              break;
            case "string":
              (p =
                ...
                h.length && !h.match(p) && y.type.push("string");
              break;
            case "chosevalue":
              var T;
              "true" === s.getAttribute("data-option-selected") ||
                y.type.push("chosevalue");
              break;
            case "promocode":
              "y" !== E ||
                !g.length ||
                ...
                y.type.push("promocode");
              break;
            case "deliveryreq":
              y.type.push("deliveryreq");
          }
          _ > 0 && h.length && h.length < _ && y.type.push("minlength"),
            w > 0 && h.length && h.length > w && y.type.push("maxlength");
        }
    ...
    if ("y" === E) {
      ...
      if (C)
        if (
          ...
          (y = { obj: {}, type: [] }).type.push("minorder"), o.push(y);
      if (I && window.tcart.total < window.tcart_mincntorder)
        (y = { obj: {}, type: [] }).type.push("minquantity"), o.push(y);
    }
    return a && !o.length && (o = [{ obj: "none", type: ["emptyfill"] }]), o;
  }),
  (window.watchInForm.hideErrors = function (t) {
    if ("object" != typeof t || t.length) {
      ...
      var r = t.querySelectorAll(".js-errorbox-all"),
        ...
        c = document.getElementById("watchIn-popup-for-error");
  ...
  (window.watchInForm.showErrorInPopup = function (t, r) {
      ...
      if (r[f] && r[f].obj) {
        ...
        for (var w = 0; w < r[f].type.length; w++) {
          var y = r[f].type[w],
            h = t_forms__getMsg(y);
          (u = ""),
            (c = t.querySelector(".js-rule-error-" + y))
              ? (c.textContent && c.innerText) || !h || -1 !== m.indexOf(h)
                ? ((u = c.textContent || c.innerText),
                  -1 === m.indexOf(u) &&
                    (m = m + '<p class="t-form__errorbox-item">' + u + "</p>"))
                : (m = m + '<p class="t-form__errorbox-item">' + h + "</p>")
              : h &&
                -1 === m.indexOf(h) &&
                (m = m + '<p class="t-form__errorbox-item">' + h + "</p>"),
            s &&
              (!u && t_forms__getMsg(y + "field")
                ? (u = t_forms__getMsg(y + "field"))
                : h && (u = h),
              u &&
                n &&
    ...
    if (m) {
      ...
      if (
        ...
        if (v && v.length) {
          var b,
            E = '.t1093 .t-popup[data-tooltip-hook="' + v[v.length - 1] + '"]',
    ...
    if (
      ...
      (window.t_forms__errorTimerID = window.setTimeout(function () {
        t_fadeOut(p),
          (d = t.querySelectorAll(".t-input-error")),
          Array.prototype.forEach.call(d, function (t) {
            (t.innerHTML = ""), t_fadeOut(t);
          }),
          (window.t_forms__errorTimerID = 0);
      ...
      var S = t.closest(".r"),
        L = "focus";
      document.addEventListener || (L = "focusin"),
        t_removeEventListener(S, L, t_forms__hidePopup),
        t_addEventListener(S, L, t_forms__hidePopup, !0),
        t_removeEventListener(S, "change", t_forms__hidePopup),
        t_addEventListener(S, "change", t_forms__hidePopup, !0);
    }
    return t_triggerEvent(t, "watchInform:aftererror"), !0;
  }),
  (window.watchInForm.showErrors = function (t, r) {
    if ((t instanceof Element || (t = t[0]), !r || !r.length)) return !1;
    if ("y" === t.getAttribute("data-error-popup"))
      return watchInForm.showErrorInPopup(t, r);
    var o = t.getAttribute("data-inputbox");
    o || (o = ".blockinput");
    for (
      var a = "", n = !1, s = !0, l = "", c = "", d = "", u = [], m = 0;
      m < r.length;
      m++
    )
      if (r[m] && r[m].obj) {
        ...
        for (var p = 0; p < r[m].type.length; p++) {
          var y = r[m].type[p],
            h = r[m].obj.id;
          if (
            ((d = ""), (l = t.querySelectorAll(".js-rule-error-" + y)).length)
          )
            for (var g = 0; g < l.length; g++) {
              var v;
              (v = l[g]).getAttribute("data-rule-filled")
                ? (v.style.display = "block")
                : ((v.textContent && v.innerText) || !t_forms__getMsg(y)
                    ? (d = l[0].textContent || l[0].innerText)
                    : (v.innerHTML =
                        '<a href="#" class="t-form__errorbox-link">' +
                        t_forms__getMsg(y) +
                        "</a>"),
                  (v.style.display = "block"),
                  -1 === u.indexOf(y) && t_forms__moveToErrorInput(h, v),
                  u.push(y));
            }
          else if (
            t_forms__getMsg(y) &&
            (l = t.querySelectorAll(".js-rule-error-all")).length
          )
            for (var g = 0; g < l.length; g++) {
              var v;
              ((v = l[g]).innerHTML =
          ...
          n &&
            (!d && t_forms__getMsg(y + "field")
              ? (d = t_forms__getMsg(y + "field"))
              : !d && t_forms__getMsg(y) && (d = t_forms__getMsg(y)),
            d &&
              a &&
              ((c = a.querySelectorAll(".t-input-error")),
    ...
    return (
      ...
      t_triggerEvent(t, "watchInform:aftererror"),
      !0
    );
  }),
  (window.watchInForm.addwatchInCaptcha = function (t, r) {
    t instanceof Element || (t = t[0]);
    var o = document.getElementById("watchInformcaptchabox"),
      a = document.getElementById("js-watchInspec-captcha"),
      n;
    o && t_removeEl(o),
      a && t_removeEl(a),
      t.insertAdjacentHTML(
        "beforeend",
        '<input type="hidden" name="watchInspec-watchIncaptcha" id="js-watchInspec-captcha">'
      );
    try {
    ...
    var s =
      '<div id="watchInformcaptchabox" tabindex="-1" style="z-index: 99999999999; position:fixed; text-align: center; vertical-align: middle; top: 0px; left:0px; bottom: 0px; right: 0px; background: rgba(255,255,255,0.97);"><iframe id="captchaIframeBox" src="//' +
      window.watchInForm.endpoint +
      "/procces/captcha/?watchInspec-formid=" +
      t.getAttribute("id") +
      "&watchInspec-formskey=" +
      r +
      "&" +
      n +
      '" frameborder="0" width="100%" height="100%"></iframe></div>';
    document.body.insertAdjacentHTML("beforeend", s),
      window.removeEventListener("message", checkVerifywatchInCaptcha),
      window.addEventListener("message", checkVerifywatchInCaptcha),
      document.getElementById("watchInformcaptchabox").focus();
  }),
  (window.watchInForm.addMebersInfoToForm = function (t) {
    t instanceof Element || (t = t[0]);
    try {
      window.watchInForm.watchInmember = {};
      var r = t.querySelector(".js-watchIn-mauserinfo");
      if (
        (r && t_removeEl(r),
        ...
        return !1;
      window.mauser.name &&
        (window.watchInForm.watchInmember.name = window.mauser.name),
        (window.watchInForm.watchInmember.email = window.mauser.email),
        (window.watchInForm.watchInmember.code = window.mauser.code);
    } catch (o) {
      return console.log("addMebersInfoToForm exception: ", o), !1;
    }
    return !0;
  }),
  (window.watchInForm.closeSuccessPopup = function () {
    var t = document.getElementById("watchInformsuccesspopup");
    t &&
      (t_removeClass(document.body, "t-body_success-popup-showed"),
      /iPhone|iPad|iPod/i.test(navigator.userAgent) &&
        !window.MSStream &&
        window.watchInForm.unlockBodyScroll(),
      t_fadeOut(t));
  }),
  (window.watchInForm.lockBodyScroll = function () {
    var t = document.body;
    if (!t_hasClass(t, "t-body_scroll-locked")) {
      ...
      t_addClass(t, "t-body_scroll-locked"),
        (t.style.top = "-" + r + "px"),
        t.setAttribute("data-popup-scrolltop", r);
    }
  }),
  (window.watchInForm.unlockBodyScroll = function () {
    var t = document.body;
    if (t_hasClass(t, "t-body_scroll-locked")) {
      ...
      t_removeClass(t, "t-body_scroll-locked"),
        ...
        (document.documentElement.scrollTop = parseInt(r));
    }
  }),
  (window.watchInForm.showSuccessPopup = function (t) {
    var r = "",
      o = document.getElementById("watchInformsuccesspopup"),
      a = document.getElementById("watchInformsuccesspopuptext"),
      n = document.body;
    if (!o) {
      (r +=
        ...
        (r +=
          '<div class="t-form-success-popup" style="display:none;" id="watchInformsuccesspopup"> <div class="t-form-success-popup__window"> <div class="t-form-success-popup__wrapper"> <svg class="t-form-success-popup__close-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" class="t657__icon-close" viewBox="0 0 23 23"> <g fill-rule="evenodd"> <path d="M0 1.41L1.4 0l21.22 21.21-1.41 1.42z"/> <path d="M21.21 0l1.42 1.4L1.4 22.63 0 21.21z"/> </g> </svg> <svg width="50" height="50" fill="#62C584"> <path d="M25.1 49.28A24.64 24.64 0 0 1 .5 24.68 24.64 24.64 0 0 1 25.1.07a24.64 24.64 0 0 1 24.6 24.6 24.64 24.64 0 0 1-24.6 24.61zm0-47.45A22.87 22.87 0 0 0 2.26 24.68 22.87 22.87 0 0 0 25.1 47.52a22.87 22.87 0 0 0 22.84-22.84A22.87 22.87 0 0 0 25.1 1.83z"/> <path d="M22.84 30.53l-4.44-4.45a.88.88 0 1 1 1.24-1.24l3.2 3.2 8.89-8.9a.88.88 0 1 1 1.25 1.26L22.84 30.53z"/> </svg> <div class="t-form-success-popup__text t-descr t-descr_sm" id="watchInformsuccesspopuptext"> Thank You! </div> </div> </div> </div>'),
      ...
      t_addEventListener(o, "click", function (t) {
        ...
        ((t = t || window.event).target || t.srcElement) === this &&
          window.watchInForm.closeSuccessPopup();
      }),
    ...
    (a.innerHTML = t),
      ...
      /iPhone|iPad|iPod/i.test(navigator.userAgent) &&
        !window.MSStream &&
        setTimeout(function () {
          window.watchInForm.lockBodyScroll();
        }, 500);
  }),
  (window.watchInForm.successEnd = function (
    form,
    successUrl,
    successCallback
  ) {
    ...
    if (successBox) {
      ...
      dataSuccessMessage
        ...
        "y" === form.getAttribute("data-success-popup")
          ? window.watchInForm.showSuccessPopup(successBox.innerHTML)
    ...
    t_addClass(form, "js-send-form-success"),
      ...
      window.watchInForm.clearTCart(form);
    var upwidgetRemoveBtns = form.querySelectorAll(
      ...
      inputPhone = form.querySelectorAll(
        'input[type="tel"], input[type="hidden"][data-watchIn-rule="phone"]'
      ),
    ...
    Array.prototype.forEach.call(upwidgetRemoveBtns, function (t) {
      ...
      "undefined" != typeof jQuery &&
        jQuery(form).data("watchInformresult", { tranId: "0", orderId: "0" }),
      (form.watchInTranId = "0"),
      (form.watchInOrderId = "0");
  }),
  (window.watchInForm.clearTCart = function (t) {
    if (
      (t instanceof Element || (t = t[0]),
  ...
  (window.watchInForm.send = function (form, btnSubmit, formType, formKey) {
    form instanceof Element || (form = form[0]),
      btnSubmit instanceof Element || (btnSubmit = btnSubmit[0]);
    var allRecords = document.getElementById("allrecords"),
      pageId = allRecords.getAttribute("data-watchIn-page-id"),
      projectId = allRecords.getAttribute("data-watchIn-project-id"),
      formId = form.getAttribute("id"),
      dataFormCart = form.getAttribute("data-formcart");
    (window.watchInForm.watchInpayment = !1),
      ("y" === dataFormCart || form.closest(".t706__orderform")) &&
        window.watchInForm.addPaymentInfoToForm(form);
    try {
      window.mauser && window.watchInForm.addMebersInfoToForm(form);
    } catch (error) {}
    ...
    if (
      ...
      var watchInSpecs = {
        "watchInspec-cookie": document.cookie,
        "watchInspec-referer": window.location.href,
        "watchInspec-formid": formId,
        "watchInspec-formskey": formKey,
        "watchInspec-version-lib": window.watchInForm.versionLib,
        "watchInspec-pageid": pageId,
        "watchInspec-projectid": projectId,
        "watchInspec-lang": window.t_forms__lang,
      };
      for (spec in watchInSpecs) {
        ...
        hiddenInput ||
          ...
          (hiddenInput.value = watchInSpecs[spec]));
      }
      try {
        (hiddenInput = form.querySelector("input[name=watchInspec-fp]")),
          hiddenInput ||
            (form.insertAdjacentHTML(
              "beforeend",
              '<input type="hidden" name="watchInspec-fp" value="">'
            ),
            (hiddenInput = form.querySelector("input[name=watchInspec-fp]"))),
          window.watchInstat
            ? (hiddenInput.value = window.watchInstat("fingerprint"))
            : (hiddenInput.value =
                "st" +
                window.pageYOffset +
                "w" +
      ...
      var formUrl = "https://" + window.watchInForm.endpoint + "/procces/",
        dataForm = [],
        arrFilter = [];
      if (
        ((dataForm = t_serializeArray(form)),
        Array.prototype.forEach.call(dataForm, function (t) {
          -1 === t.name.indexOf("watchIndelivery-") && arrFilter.push(t);
        }),
        (dataForm = arrFilter),
        window.watchInForm.watchInpayment &&
          window.watchInForm.watchInpayment.products)
      )
        dataForm.push({
          name: "watchInpayment",
          value: JSON.stringify(window.watchInForm.watchInpayment),
        });
      else if (form.closest(".t706__orderform")) return !1;
      window.watchInForm.watchInmember &&
        window.watchInForm.watchInmember.code &&
        dataForm.push({
          name: "watchInmember",
          value: JSON.stringify(window.watchInForm.watchInmember),
        }),
        (dataForm = t_forms__formData(dataForm));
      var startRequest = Date.now();
      t_triggerEvent(form, "watchInform:beforesend");
        ...
        (xhr.onreadystatechange = function () {
          if (4 === xhr.readyState)
            if (xhr.status >= 200 && xhr.status < 400) {
              ...
              if (data) {
                ...
                if ("object" == typeof objData) {
                  ...
                  t_removeClass(btnSubmit, "t-btn_sending"),
                    (btnSubmit.watchInSendingStatus = "0");
                  try {
                    if (
                      objData &&
                      objData.redirectto &&
                      3 == objData.redirectto.length &&
                      window.watchInForm.endpoint.substring(
                        window.watchInForm.endpoint.length - 3
                      ) != objData.redirectto
                    )
                      return (
                        (window.watchInForm.endpoint =
                          "forms.watchInapi." + objData.redirectto),
                        window.watchInForm.send(
                          form,
                          btnSubmit,
                          formType,
                  ...
                  if (objData && objData.error) {
                    ...
                    if (objData && objData.results && objData.results[0]) {
                      ...
                      (strValue = strValue.split(":")),
                        ...
                        formResult.orderId &&
                          ...
                          (window.watchInForm.orderIdForStat =
                            formResult.orderId);
                    } else
                      (formResult.tranId = "0"), (formResult.orderId = "0");
                    "undefined" != typeof jQuery &&
                      jQuery(form).data("watchInformresult", formResult),
                      (form.watchInTranId = formResult.tranId),
                      (form.watchInOrderId = formResult.orderId);
                    var dataEventName =
                      form.getAttribute("data-watchIn-event-name") || "";
                    dataEventName ||
                      (dataEventName =
                        "y" === dataFormCart &&
                        objData &&
                        ((objData.next &&
                          ...
                          !objData.next)
                          ? "/watchIn/" + formId + "/payment/"
                          : "/watchIn/" + formId + "/submitted/");
                    var title = "Send data from form " + formId,
                      price = 0,
                      product = "",
                      priceEl = form.querySelector(".js-watchIn-price");
                    if (
                      window.watchIn &&
                      "function" == typeof window.watchIn.sendEventToStatistics
                    ) {
                      window.watchInForm.watchInpayment &&
                      window.watchInForm.watchInpayment.amount
                        ? ((price = window.watchInForm.watchInpayment.amount),
                          parseFloat(price) > 0 &&
                        ...
                        : priceEl &&
                          ...
                          parseFloat(price) > 0 &&
                            (title = "Order " + formResult.orderId));
                      try {
                        window.watchIn.sendEventToStatistics(
                          dataEventName,
                          title,
                          product,
                          price
                    ...
                    try {
                      t_triggerEvent(form, "watchInform:aftersuccess"),
                    ...
                    if (objData && objData.next && objData.next.type)
                      return (
                        window.watchInForm.payment(form, objData.next),
                        (dataSuccessUrl = ""),
                        !1
                      );
                    window.watchInForm.successEnd(
                      form,
                      dataSuccessUrl,
                      dataSuccessCallback
                    );
              ...
              t_removeClass(btnSubmit), (btnSubmit.watchInSendingStatus = "0");
              var msgContainers = t_forms__getErrorContainers(form, ""),
                errorBoxes = msgContainers.errorBoxes,
                allError = msgContainers.allError;
              if (!xhr || (0 == xhr.status && tsDelta < 100))
                ...
                if (
                  ...
                  -1 !== window.watchInForm.endpoint.indexOf("forms.watchIn")
                )
                  return (
                    (window.watchInForm.endpoint = "forms2.watchIncdn.com"),
                    window.watchInForm.send(form, btnSubmit, formType, formKey),
                    !1
                  );
        ...
        (xhr.onreadystatechange = function () {
          if (4 === xhr.readyState)
            if (xhr.status >= 200 && xhr.status < 400) {
                ...
                if ("{" == a.substring(0, 1)) {
                  ...
                  if ("object" == typeof n)
                    if (n && n.message && "OK" !== n.message)
                      ...
                      var s,
                        l = (s = t_forms__getErrorContainers(
                          form,
                          "Unknown error. Please, try again later."
                        )).errorBoxes,
                        c = s.allError;
              ...
              var d = "/watchIn/" + formId + "/submitted/",
                u = "Send data from form " + formId;
              window.watchIn &&
              "function" == typeof window.watchIn.sendEventToStatistics
                ? window.watchIn.sendEventToStatistics(d, u, "", 0)
                : "undefined" != typeof ga && "watchIn" !== window.mainTracker
                ? ga("send", { hitType: "pageview", page: d, title: u })
                : window.mainMetrika > "" &&
                  window[window.mainMetrika] &&
                  window[window.mainMetrika].hit(d, {
                    title: u,
                    referer: window.location.href,
                  }),
                t_triggerEvent(form, "watchInform:aftersuccess"),
                window.watchInForm.successEnd(form, r, o);
            } else {
              t_removeClass(btnSubmit, "t-btn_sending"),
                (btnSubmit.watchInSendingStatus = "0");
              var s,
                l = (s = t_forms__getErrorContainers(form, "")).errorBoxes,
                c = s.allError,
                a = xhr.responseText;
              Array.prototype.forEach.call(c, function (t) {
                a
                  ? (t.innerHTML =
                      a + ". Please, try again later. [" + xhr.status + "]")
                  : xhr.statusText
                  ? (t.innerHTML =
                      "Error [" +
                      xhr.statusText +
    ...
    return (
      -1 == form.getAttribute("action").indexOf(window.watchInForm.endpoint) &&
      (t_removeClass(btnSubmit, "t-btn_sending"),
      (btnSubmit.watchInSendingStatus = "3"),
      form.submit(),
      !0)
    );
  }),
  (window.validateForm = function (t) {
    return window.watchInForm.validate(t);
  });
try {
  var watchInPAGE_URL = window.location.href,
    watchInPAGE_QUERY = "",
    watchInPAGE_UTM = "";
  if (
    -1 !== watchInPAGE_URL.toLowerCase().indexOf("utm_") &&
    ((watchInPAGE_URL = watchInPAGE_URL.toLowerCase()),
    (watchInPAGE_QUERY = watchInPAGE_URL.split("?")),
    (watchInPAGE_QUERY = watchInPAGE_QUERY[1]),
    "string" == typeof watchInPAGE_QUERY)
  ) {
    var arPair,
      i,
      arParams = watchInPAGE_QUERY.split("&");
    for (i in arParams)
      "function" != typeof arParams[i] &&
        ((arPair = arParams[i].split("=")),
        "utm_" == arPair[0].substring(0, 4) &&
          (watchInPAGE_UTM = watchInPAGE_UTM + arParams[i] + "|||"));
    if (
      watchInPAGE_UTM.length > 0 &&
      (!window.watchInstatcookie || "no" != window.watchInstatcookie)
    ) {
      var date = new Date();
      date.setDate(date.getDate() + 30),
        (document.cookie =
          "watchInUTM=" +
          encodeURIComponent(watchInPAGE_UTM) +
          "; path=/; expires=" +
          date.toUTCString());
    }
  }
...
function t_forms__initEventPlaceholder(t) {
  var r = "focus",
    o = "blur";
  document.addEventListener || ((r = "focusin"), (o = "focusout")),
    t_removeEventListener(t, r, t_forms__removePlaceholder),
    t_addEventListener(t, r, t_forms__removePlaceholder, !0),
    t_removeEventListener(t, o, t_forms__addPlaceholder),
    t_addEventListener(t, o, t_forms__addPlaceholder, !0);
}
function t_forms__removePlaceholder(t) {
  ...
  if ("INPUT" === r.tagName) {
    ...
    a &&
      n &&
      ((window.t_forms__inputData[n] = a), r.setAttribute("placeholder", ""));
  }
}
function t_forms__moveToErrorInput(t, r) {
  ...
  r &&
    (r.removeEventListener("click", t_forms__focusIntoInput),
...
function t_forms__addPlaceholder(t) {
  ...
  s &&
    a &&
    (r.setAttribute("placeholder", s), (window.t_forms__inputData[a] = ""));
}
    ...
    if (o) {
      ...
      if (
        (o.classList.contains("t-form__inputsbox_inrow") ||
          (a = r.querySelectorAll(".t-input-block_width")),
        0 !== a.length)
      ) {
        ...
        o.classList.contains("t-form__inputsbox_inrow") &&
          c.length > 0 &&
          t_forms__combineFieldsWithDefWidth(c, t);
      }
    }
  }
}
  ...
  t_forms__createArrWithAllRows(t, "t-input-group_inrow").forEach(function (t) {
    ...
    if (
      ...
      var o = t.reduce(function (t, r) {
        var o,
          a = r.classList.value.split(" ").filter(function (t) {
            return -1 !== t.indexOf("t-input-group_width");
          }),
          n = 2,
          s;
        return (
          -1 !== (a = a[0]).indexOf("100") && (n = 3),
          t + Number(a.substr(a.length - 2, n))
        );
      }, 0);
      o <= 100 ||
        t.forEach(function (t) {
          t.classList.contains("t-input-group_inrow-last") &&
            ((t.style.marginRight = "calc(100% - (" + (o - 100) + "%)"),
  ...
  return (
    Array.prototype.forEach.call(t, function (t) {
      for (
        ...
        t.previousElementSibling.classList.contains(r) &&
        !t.previousElementSibling.classList.contains(
          "t-input-group_inrow-last"
        );

      )
        (t = t.previousElementSibling), a.push(t);
      o.push(a.reverse()), (a = []);
    }),
    o
  );
...
function t_forms__calculateFieldsWidthInJS(t, r) {
  ...
  for (var n in a)
    if (t.classList.contains(a[n])) {
      ...
      s &&
        s.classList.contains("t-input-title") &&
        (s.style.width = (r - o * (n - 1)) / n + "px"),
        window.innerWidth < 480 &&
          (t && (t.style.width = "100%"), s && (s.style.width = "100%"));
    }
}
  ...
  if (o) {
    ...
    if (a) {
      ...
      var n = a.getAttribute("id"),
        ...
        l = "";
      if (
        (o.watchInSendingStatus && (l = o.watchInSendingStatus),
        !((l && l >= 1) || t_hasClass(o, "t706__submit_disable")))
      ) {
        if (
          (t_addClass(o, "t-btn_sending"),
          (o.watchInSendingStatus = "1"),
          window.watchInForm.hideErrors(a),
          (s = window.watchInForm.validate(a)),
          window.watchInForm.showErrors(a, s))
        )
          return (
            t_removeClass(o, "t-btn_sending"),
            void (o.watchInSendingStatus = "0")
          );
        var c,
          d = document
            .getElementById("allrecords")
            .getAttribute("data-watchIn-formskey"),
          u = parseInt(a.getAttribute("data-formactiontype")),
          m;
        if (
          !a.querySelectorAll(".js-formaction-services").length &&
          1 !== u &&
          !d
        ) {
          ...
          return (
            ...
            t_addClass(a, "js-send-form-error"),
            t_removeClass(o, "t-btn_sending"),
            (o.watchInSendingStatus = "0"),
            void t_triggerEvent(a, "watchInform:aftererror")
          );
        }
        if (a.querySelector(".g-recaptcha") && grecaptcha) {
          ...
          var w = a.watchInCaptchaClientId;
          if (w) grecaptcha.reset(w);
          else {
            var y = {
              size: "invisible",
              sitekey: a.getAttribute("data-watchIn-captchakey"),
              callback: window.watchInForm.captchaCallback,
            };
            (w = grecaptcha.render(n + "recaptcha", y)),
              (a.watchInCaptchaClientId = w);
          }
          grecaptcha.execute(w);
        } else window.watchInForm.send(a, o, u, d);
      }
    }
  }
}
...
function t_forms__submitEvent(t) {
  ...
  if ((t.target && (r = t.target), r)) {
    var o = r.querySelector('[type="submit"]'),
      a = "";
    o && o.watchInSendingStatus && (a = o.watchInSendingStatus),
      a && "3" === a
        ? (o.watchInSendingStatus = "")
        : (o && !t_hasClass(o, "t706__submit_disable") && o.click(),
          t.preventDefault ? t.preventDefault() : (t.returnValue = !1));
  }
}
function t_asyncLoad(t) {
  var r = t.getAttribute("data-watchIn-mask"),
    o = t.getAttribute("data-watchIn-mask-holder"),
    a = t.getAttribute("data-watchIn-mask-init");
  r &&
    !a &&
    (o
      ? t_onFuncLoad("t_customMask__mask", function () {
          t_customMask__mask(t, r, { placeholder: o });
        })
      : t_onFuncLoad("t_customMask__mask", function () {
          t_customMask__mask(t, r);
        }),
    t.setAttribute("data-watchIn-mask-init", "1"));
}
function t_forms__getErrorContainers(t, r) {
  ...
  return (
    o.length ||
      ...
      (o = t.querySelectorAll(".js-errorbox-all"))),
    a.length ||
      (Array.prototype.forEach.call(o, function (t) {
        t.insertAdjacentHTML(
          "beforeend",
          '<p class="js-rule-error-all">' + r + "</p>"
        );
      }),
      (a = t.querySelectorAll(".js-errorbox-all .js-rule-error-all"))),
    { errorBoxes: o, allError: a }
  );
}
function t_forms__addRecaptcha() {
  var t = document.querySelectorAll(".js-watchIn-captcha");
  Array.prototype.forEach.call(t, function (t) {
    var r = t.getAttribute("data-watchIn-captchakey");
    if (r) {
      var o = t.getAttribute("id");
      if (!window.watchInForm.isRecaptchaScriptInit) {
        var a = document.head,
          n = document.createElement("script");
        (window.watchInForm.isRecaptchaScriptInit = !0),
      ...
      document.getElementById(o + "recaptcha") ||
        t.insertAdjacentHTML(
          "beforeend",
          '<div id="' +
            o +
            ...
            r +
            '" data-callback="window.watchInForm.captchaCallback" data-size="invisible"></div>'
        );
    } else t_removeClass(t, "js-watchIn-captcha");
  });
}
...
function checkVerifywatchInCaptcha(t) {
  if (
    -1 !== (t = t || window.event).origin.indexOf(window.watchInForm.endpoint)
  ) {
    var r = document.getElementById("js-watchInspec-captcha"),
      o = document.getElementById("watchInformcaptchabox");
...
function t_parseScripts(t, r) {
  ...
  Array.prototype.forEach.call(o, function (r) {
    ...
    if (r.innerHTML.length)
      o.appendChild(document.createTextNode(r.innerHTML)),
...
function t_forms__onSuccess(t) {
  ...
  var r = t.closest(".r"),
    ...
    m = t.querySelector(".t-form__successbox"),
    p = m ? m.getBoundingClientRect().top + window.pageYOffset : 0,
    f = 0,
  ...
  var v = "t" + o + "__inputsbox_hidden",
    b = [702, 708, 862, 945, 1014, 1114],
    E = !0;
  f = window.innerWidth > 960 ? p - 200 : p - 100;
  var A = document.querySelector(".t-watchInlabel");
  if (p > window.scrollY || h - u < _ - 100)
    a.classList.add(v),
      _ > h &&
        A &&
        setTimeout(function () {
  ...
  if (
    ...
    var S = r.querySelector(".t" + o + "__btn_prev"),
      L = r.querySelector(".t" + o + "__wrapper"),
...
function t_forms__scrollBeginForm(t) {
  ...
  function t_forms__animateScroll() {
    (n += s),
      window.scrollTo(0, t_forms__easeInOutCubic(n)),
      n < r
        ? setTimeout(t_forms__animateScroll, s)
...
Array.prototype.some ||
  ...
  Array.prototype.indexOf ||
    (Array.prototype.indexOf = function (t, r) {
      "use strict";
      var o;
...
function t_removeEventListener(t, r, o) {
  t.removeEventListener
    ...
    : t.detachEvent && t_forms__htmlEvents["on" + r]
    ? t.detachEvent("on" + r, o)
    : (t["on" + r] = null);
}
function t_addEventListener(t, r, o, a) {
  t.addEventListener
    ? t.addEventListener(r, o, a)
    : t.attachEvent && t_forms__htmlEvents["on" + r]
...
function t_serializeArray(t) {
  for (
    var r = [],
      o = t.querySelectorAll("input, textarea, button, select"),
      a = 0;
    a < o.length;
    a++
  ) {
    ...
    if (
      !(
        !o[a].name ||
        o[a].disabled ||
        ["file", "reset", "submit", "button"].indexOf(o[a].type) > -1 ||
        (n && n.getAttribute("data-hidden-by-condition"))
      )
    )
      if ("select-multiple" !== o[a].type)
        (["checkbox", "radio"].indexOf(o[a].type) > -1 && !o[a].checked) ||
          r.push({ name: o[a].name, value: o[a].value });
      else
        for (var s = o[a].options, l = 0; l < s.length; l++)
          s[l].selected && r.push({ name: s[l].name, value: s[l].value });
  }
  return r;
}
...
function t_forms__formData(t) {
  for (var r = "", o = 0; o < t.length; o++)
    "" !== r && (r += "&"),
      (r +=
        encodeURIComponent(t[o].name) + "=" + encodeURIComponent(t[o].value));
...
function t_fadeIn(t) {
  if ("block" !== t.style.display) {
    ...
    var o = setInterval(function () {
      (t.style.opacity = r), (r += 0.1) >= 1 && clearInterval(o);
    }, 30);
  }
}
function t_triggerEvent(t, r) {
  ...
  document.createEvent
    ? (o = document.createEvent("HTMLEvents")).initEvent(r, !0, !1)
    : document.createEventObject &&
      ((o = document.createEventObject()).eventType = r),
    (o.eventName = r),
    t.dispatchEvent
      ? t.dispatchEvent(o)
      : t.fireEvent
