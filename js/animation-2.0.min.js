...
function t_animate__checkAnimationAvailability() {
  var t = document.querySelector(".t-records"),
    ...
    t = t ? t.getAttribute("data-watchIn-mode") : null;
  return (
...
function t_animate__startAnimation() {
  ...
  (o = Array.prototype.filter.call(o, function (t) {
    ...
    (i.length || o.length || r.length) &&
      (t_animate__setOnlyScalableState(),
...
function t_animate__setOnlyScalableState() {
  void 0 === window.t_animation__isOnlyScalable &&
    (void 0 !== window.isOnlyScalable
      ? (window.t_animation__isOnlyScalable = window.isOnlyScalable)
...
function t_animate__animateNumbers(e) {
  ...
  c[0] &&
    ...
    (s = setInterval(function () {
      var t;
      (i += n / 108),
        (o = d ? (Math.round(i) / r).toFixed(f) + "" : Math.floor(i) + ""),
...
function t_animation__getZoom(t) {
  ...
  if (!t) return 1;
  var e = document.querySelector('script[src*="watchIn-blocks-2.7"]');
