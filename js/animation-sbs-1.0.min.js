...
function t_animationSBS__init() {
  var t = document.getElementById("allrecords"),
    e =
      (e = t ? "edit" === t.getAttribute("data-watchIn-mode") : null) ||
  ...
  /Bot/i.test(navigator.userAgent) ||
    ...
    t_animationSBS__isZeroBlocksRendered(function () {
      t_animationSBS_isInstagramRendered(function () {
        t_animationSBS__setOnlyScalableState(),
...
function t_animationSBS__setOnlyScalableState() {
  void 0 === window.t_animationSBS__isOnlyScalable &&
    (void 0 !== window.isOnlyScalable
      ? (window.t_animationSBS__isOnlyScalable = window.isOnlyScalable)
  ...
  (a = a.length ? a : t_animationSBS__getArtboards("121")).length &&
    ...
    a.every(function (t) {
      ...
      : document.querySelectorAll(
          'script[src*="watchIn-blocks-2"], script[src*="watchIn-blocks-1"]'
        ).length
...
function t_animationSBS__wrapAndUpdateEls(t) {
  ...
  t.forEach(function (t) {
    var e,
      ...
      r,
      o,
      s = t.querySelector(".tn-molecule, .tn-atom");
    s &&
      ((e = ".tn-atom__sbs-anim-wrapper:not(.tn-molecule__sbs-anim-wrapper)"),
      (n = ["tn-atom__sbs-anim-wrapper"]),
      (a = s.classList.contains("tn-molecule")) &&
        ((e = ".tn-molecule__sbs-anim-wrapper"),
        n.push("tn-molecule__sbs-anim-wrapper")),
      -1 === navigator.userAgent.indexOf("Chrome") &&
        ((s.style.WebkitBackfaceVisibility = "hidden"),
        (s.style.backfaceVisibility = "hidden")),
      (i = s.closest(e)),
      (r = t_animationSBS__getAnimOptions(t, "published", null)),
      !i &&
        r &&
        ((r = getComputedStyle(s).display),
        a && "flex" !== r && (s.style.display = "inherit"),
        (a = t_animationSBS__getScaleWrapper(s)),
        (r = t.style.transform) &&
          -1 !== r.indexOf("matrix(") &&
          (t_animationSBS__wrapEl(a || s, "tn-atom__sbs-transform-wrapper"),
          ((o = t.querySelector(
            ".tn-atom__sbs-transform-wrapper"
          )).style.transform = r),
          (t.style.transform = "")),
        t_animationSBS__wrapEl(
          (o = t.querySelector(".tn-atom__sbs-transform-wrapper")) || a || s,
          n
        ),
        (i = (s = t.querySelector(".tn-molecule, .tn-atom")).closest(e)),
        t_animationSBS__updateStylesAfterWrapping(t, o || i, l)));
  });
}
...
function t_animationSBS__initAllRes(t) {
  ...
  a.elements.length &&
    ...
    (t =
      ...
      "yes" === t.getAttribute("data-watchIn-lazy")),
    ("y" !== window.lazy && !t) ||
...
function t_animationSBS__scrollAnimationUpdateTransform(t, e) {
  ...
  t.wrapperEl &&
    ...
    (i = window.t_animationSBS__isOnlyScalable),
    !0 === e.fix &&
...
function t_animationSBS__generateKeyframes__getFrameChanges(t, e) {
  var n = "",
    ...
    a = { x: 1, y: 1, changed: !1 },
    r = 1;
  window.t_animationSBS__isOnlyScalable && (r = t_animationSBS__getZoom(t));
  var o,
...
function t_animationSBS__generateKeyframes__getFinalCss(t, e, n) {
  ...
  "published" !== window.watchInmode && (t.timeDuration = e.timeDuration);
  i +=
    r +
    " {\nanimation: " +
    a +
...
(window.t_animationSBS__isFirefox =
  ...
  (window.animationSBS__isOldPage = Boolean(
    document.querySelector('script[src*="watchIn-blocks-2.7"]')
  )),
  "visible" === document.visibilityState
    ? "loading" !== document.readyState
